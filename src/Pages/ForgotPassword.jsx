...
const ForgotPassword = () => {
  ...
  return (
    <div className=" h-screen flex-center  mx-auto font-bold text-center mobile:p-8 mobile:bg-mygray-200 ">
      <div className="flex-col-center w-full max-w-100 bg-white mobile:border-2 mobile:border-mygray-100 mobile:shadow-myshadow-100 rounded-8 py-5 px-6">
        ...
        >
          ...
          <div className="flex flex-col items-start justify-center w-full">
            ...
            <div
              className={`flex w-87 h-10.75 border-2  bg-mygray-200 rounded-4 text-center font-normal ${errors.capcha ? "border-red-500 outline-0" : "border-myblue-200"}`}
            >
              <input
                type="text"
                inputMode="numeric"
